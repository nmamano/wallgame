...
# Add the scripts directory to the path so we can import model
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))
from model import ResNet

# CONFIGURATION
MODEL_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../models_8x8_standard/model_49.pt'))
COLUMNS = 8
ROWS = 8
...
def get_starting_input():
    ...
    # Positions (Standard variant 8x8)
    # Red: Cat at (0, 0), Mouse at (0, 7)
    # Blue: Cat at (7, 0), Mouse at (7, 7)
    red_cat = (0, 0)
    red_mouse = (0, 7)
    blue_cat = (7, 0)
    blue_mouse = (7, 7)
...
def check():
    ...
    print(f"\n--- Model Output for Starting Board (Gen 49) ---")
