...
function GamePage() {
  ...
  const initializeGame = useCallback(
    (
      ...
      metaGameActions.resetMetaGameActions();
        ...
        >
          ...
          >
            ...
            <BoardPanel
              ...
              userRematchResponse={userRematchResponse}
              handleAcceptRematch={handleAcceptRematch}
              handleDeclineRematch={handleDeclineRematch}
              openRematchWindow={openRematchWindow}
              handleExitAfterMatch={handleExitAfterMatch}
              rows={rows}
              cols={cols}
              boardPawns={boardPawns}
              boardWalls={boardWalls}
              stagedArrows={stagedArrows}
              playerColorsForBoard={playerColorsForBoard}
              interactionLocked={interactionLocked}
              lastMove={lastMove}
              draggingPawnId={draggingPawnId}
              selectedPawnId={selectedPawnId}
              stagedActionsCount={stagedActions.length}
              actionablePlayerId={actionablePlayerId}
              ...
              hasActionMessage={hasActionMessage}
              actionError={actionError}
              actionStatusText={actionStatusText}
              clearStagedActions={clearStagedActions}
              commitStagedActions={commitStagedActions}
            />
          ...
          >
            <GameInfoPanel
              ...
              interactionLocked={interactionLocked}
              isMultiplayerMatch={isMultiplayerMatch}
              unsupportedPlayers={unsupportedPlayers}
            ...
            <ActionsPanel
              ...
              handleDismissIncomingNotice={
                metaGameActions.handleDismissIncomingNotice
              }
              ...
              handleCancelTakebackRequest={
                metaGameActions.handleCancelTakebackRequest
              }
              handleDismissOutgoingInfo={
                metaGameActions.handleDismissOutgoingInfo
              }
