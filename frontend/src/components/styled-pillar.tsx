...
type SquareOrientation = "W-E" | "N-S";
type QuarterCircleOrientation = "W-S" | "N-W" | "E-N" | "S-E";
type PillCapOrientation = "N" | "S" | "E" | "W";

interface LinearGradientSquareParams {
  boundingBox: BoundingBox;
...
interface PillCapParams {
  boundingBox: BoundingBox;
  orientation: PillCapOrientation;
  color: string;
}

interface FourColorSquareParams {
  boundingBox: BoundingBox;
  colors: Record<EdgeColorKey, string>;
}

type TwoColorSquareOrientation = "N" | "S" | "E" | "W";

interface SideColorSquareParams {
  boundingBox: BoundingBox;
...
type CornerTwoColorSquareOrientation = "NE" | "NW" | "SE" | "SW";

interface CornerColorSquareParams {
  boundingBox: BoundingBox;
...
type ThreeSidedSquareMainOrientation = CornerTwoColorSquareOrientation;
type ThreeSidedSquareSideOrientation = TwoColorSquareOrientation;

interface ThreeSidedSquareParams {
  boundingBox: BoundingBox;
...
interface ThreeColoredSidesSquareParams {
  boundingBox: BoundingBox;
  colors: Record<EdgeColorKey, string | null>;
}
