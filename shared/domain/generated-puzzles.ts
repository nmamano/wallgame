...
export const GENERATED_PUZZLES: Record<string, Puzzle> = {
  ...
  "11": {
    ...
    humanPlaysAs: 2,
    moves: [[{ actions: [{ type: "wall", target: [5, 3], wallOrientation: "vertical" }, { type: "wall", target: [7, 3], wallOrientation: "vertical" }] }]],
  },
  ...
  "12": {
    ...
    humanPlaysAs: 2,
    moves: [[{ actions: [{ type: "cat", target: [1, 5] }, { type: "cat", target: [2, 5] }] }]],
  },
  ...
  "13": {
    ...
    humanPlaysAs: 2,
    moves: [[{ actions: [{ type: "cat", target: [2, 6] }, { type: "wall", target: [0, 4], wallOrientation: "vertical" }] }]],
  },
  ...
  "14": {
    ...
    humanPlaysAs: 2,
    moves: [[{ actions: [{ type: "wall", target: [5, 4], wallOrientation: "horizontal" }, { type: "wall", target: [4, 4], wallOrientation: "vertical" }] }]],
  },
};
